...
describe('StormGlass client', () => {
      // Diz ao axios que ele é um typo de mock também
  ...
  it(`should get a generic error from StormGlass service when the 
  request fail before reaching the service`, async () => {
    const lat = -33.792726;
    const lng = 151.289824;
